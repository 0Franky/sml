...
- **Env** (override rapido, vince sul file): `HARNESS_TOKEN_MATRIOSKA_PCT`, `HARNESS_TOKEN_REORDER_PCT`, `HARNESS_WATCH_MATRIOSKA`, `HARNESS_WATCH_REORDER`, `HARNESS_MAX_DEPTH`, `HARNESS_OUTPUT_RESERVE_PCT`, `HARNESS_MESSAGES_WINDOW_N`, `HARNESS_GATHERING_MODE`, `HARNESS_GATHERING_MIN_TASKS`.
