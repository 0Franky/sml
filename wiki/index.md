...
- [`training-taxonomy/README.md`](training-taxonomy/README.md) 🆕⭐ — **tassonomia completa dei dati di training**: **16 aree** · ~75 topic · ~210 foglie, ognuna taggata Q/L + skill-target + example-space (con-hint/senza-hint/wrong-awareness/wrong-recovery/other). Backbone + schema + Benchmark Coverage Matrix + macro-curriculum 3 fasi. Copertura verificata vs benchmark pubblici. Example-space schedulato per 2026-06-25 20:00
