...
- [`training-taxonomy/templates/`](training-taxonomy/templates/) 🆕🧬 — **sistema template-inheritance** (motore del rollout gold): `area02-group1-destructive.template.md` (skeleton + §SLOT 26 + §ORACOLO-PATTERN O1-O8 + §REWARD-PATTERN) + 4 leaf-delta (1.1-1.4) + `expand.py` + `EXPANSION.md` → producono i `gold-example-area02-*.expanded.md` (gold canonici di training, **byte-verificabili**). Pattern validato 360° (byte-equal round-trip + generalizza + fix-once-propaga); oracoli **eseguiti verdi** 2026-06-29 (6/6 spec)
