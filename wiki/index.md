...
- [`training-taxonomy/training-curriculum-design.md`](training-taxonomy/training-curriculum-design.md) 🆕⭐ — **design del curriculum** (stadi/ordine/dati/reward) — risposta ai "round" utente, validato vs **NVIDIA Nemotron**: SFT-teoria → RL-verificabile (GRPO+curriculum-difficoltà) → preference-corto → merge; +3 correzioni +toggle reasoning-on/off. Commercial-clean
