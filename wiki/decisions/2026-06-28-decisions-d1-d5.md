...
- **Aggiornamento 2026-09-11** (Fra ha ri-posto la domanda, TG msg 2153, chiedendo verifica; fatta su fonti primarie): **la decisione regge e si rafforza** — i pensieri continui non sono discriminabili corretto/sbagliato da PRM/ORM (arXiv:2510.12167), quindi il reward per-fase e l'ancoraggio `[V]` non hanno appiglio nel latente. L'ibrido FUTURO ha ora una forma pubblicata e allenabile: **SWITCH** (arXiv:2606.13106, token di confine `<swi>`/`</swi>` + GRPO, curriculum visibile→latente) e **DiscoLoop** (arXiv:2607.00341, canale discreto accanto a quello continuo). GPT-6 Astra (set 2026) usa «recurrent depth» **secondo la stampa** (The Information, TechCrunch, Fortune), non confermato da OpenAI, e conserva la CoT a token. **Cosa la ribalterebbe**: passi latenti discriminabili da un PRM a scala ≥7B, o un plateau misurato dei marker su task search-heavy. Numeri e fonti: `wiki/todo.md` «BATCH IDEE 2026-09-11», riga 8.
- **Raffinamento di Fra (TG msg 2177, 2026-09-11)**: blocco latente → **verbalizzazione** del pensiero → **verifica verbalizzata**, non latente; scartata la doppia verifica latente+verbale. Reco confermata: la verifica resta nei token e ancorata a tool/artefatti, perché (i) i pensieri continui non sono discriminabili da PRM/ORM (arXiv:2510.12167) e (ii) la verbalizzazione è un *report* che può divergere dallo stato latente (Qwen 32B nega le iniezioni che rileva, arXiv:2602.20031). Il blocco latente copre la parte di **ricerca/pianificazione** (dove Coconut vince), mai la verifica.
