...
**P9 — eval-awareness** · LURE 2605.26438 **IMPORTA** ([V] mio; prefisso = replay di una traiettoria **reale** — abbiamo i trace di `run-scene` — e coda = la fixture con oracolo: la scena non «sa di esercizio»; forma raccomandata per le scene nuove, playbook §4) · 2509.13333 **CITA** (l'eval-awareness cresce con **legge di potenza** nella scala, 0.27B-70B: a 27-36B c'è già; accanto a 2505.23836) · 2510.20487 **CITA + todo** (probe lineare eval-vs-deploy come **lint** delle fixture: un forward pass sul 9B locale; PDF prima) · SENTINEL 2606.12908 **CITA** (dai pattern di errore si generano task mirati = il nostro loop gap→classe #18, automatizzato) · Tatemae 2604.26511 e 2607.24758 **CITA** (alignment faking come scelta del tool; persiste anche senza il linguaggio delle conseguenze) · 2602.08449 regime-blind **SCARTA** (adversarial invariance training: costo alto, nessuna decisione ora) · SYNTHAGENT 2601.22511 **SCARTA** (generico).
