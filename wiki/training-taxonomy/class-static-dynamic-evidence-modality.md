...
> generalizza l'acceleratore** (`class-tool-perception-fidelity.md:169`, «localizza il freno e generalizza»). Qui i negativi nascono gia'
> cross-dominio.
...
- **② CORRETTEZZA-DEI-PASSI dove esiste un oracolo** — per-esempio **solo se ⊥ al ramo**, con lo scope
  ...
  - **(a) MIRATEZZA della riparazione** — **CONDIZIONATA all'aver tentato una riparazione** (altrimenti il
    ...
    `class-tool-perception-fidelity.md:191`, «era grondato INCONDIZIONATAMENTE»): il lock deve stare **al giunto giusto** — non un lock globale che
