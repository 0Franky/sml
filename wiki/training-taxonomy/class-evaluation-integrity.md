...
- **CapCode / CapReward** (arXiv:2606.07379): test randomizzati con un livello di performance **deliberatamente cappato** → un punteggio **sopra il cap è prova** di cheating, non un sospetto. È un hack-check a costo basso per le fixture di questa classe: un sotto-insieme di test con tetto noto, e chi lo supera ha manomesso il metro. ⛔ Da costruire solo dopo il PDF (todo).
