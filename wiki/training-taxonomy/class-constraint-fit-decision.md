...
| **sforzo-proporzionato-alla-posta** *(creata 2026-07-25)* | quanto SFORZO/rigore/struttura — **4 facce**: profondita' di verifica · registro della comunicazione · stile del codice (produzione vs didattico) · scala dell'ingegnerizzazione | one-liner vs design-doc; e **dentro** lo stesso progetto: cura alta sui punti di passaggio, bassa sulle foglie | [[class-right-effort-for-stakes]] (**riceve la POSTA da** [[class-project-stakes-awareness]]; a sua volta padre di [[class-code-optimization]]) |
