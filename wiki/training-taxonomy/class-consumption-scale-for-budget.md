...
- **AnySearch** (arXiv:2609.00813, codice): una sola policy RL che rispetta **qualsiasi budget dichiarato a inferenza** — budget iniettato nel prompt + **curriculum sui budget**. È il regime di training di questa classe: i bracci scarso/abbondante delle scene sono il curriculum a due punti; il reward resta l'oracolo (spesa reale vs dichiarata), mai il campo budget (#32). ⛔ Regime da definire dopo il PDF (todo).
...
- **BAGEN** (arXiv:2606.00198): i modelli di frontiera sono **sistematicamente ottimisti** e continuano a spendere su task ormai persi invece di avvisare; l'early stop risparmia 28-64% sui fallimenti. Fissa il **negativo** di questa classe: il gold non è «spendi meno», è **avvisa presto quando è perso** (gemello di [[class-effort-honesty-under-difficulty]]) — così «insisti sempre» non passa. Candidato held-out (#18), licenza da verificare (#29).
