...
- [[gold-example-area02-criticality|gold-example-area02-criticality.expanded]] (canonico Foglia 1.1 — struttura, marker, verifier, 5 classi, §3bis) · [[gold-example-area02-3.1-gitcheck.expanded|3.1 git/backup]] · [[gold-example-area02-3.2-dep-check|3.2 dep-check]] (struttura §0/§1bis/§2bis/§2ter/§3/§4 replicata).
