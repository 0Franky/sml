...
description: Classe-PADRE (radice) di training — auditare il PROPRIO ragionamento contro il ground-truth invece di fidarsi del primo-passo. Quattro figlie: audit-del-progresso (stagnation-recovery), audit-delle-assunzioni (transfer-assumption-audit), audit-coerenza-mezzi-fini (consequence-intention-conflict), audit-della-provenienza (confabulation-retrieval-failure). Gerarchia obbligatoria (regola #20).
type: training-class
...
**Skill radice** (imparata una volta, condivisa dalle figlie): **sospendere la fiducia nel proprio output intermedio e verificarlo** contro un riferimento oggettivo (l'oracolo, l'esito reale, il vincolo). Le quattro figlie sono i quattro OGGETTI di questo audit.
...
## Le quattro figlie (cosa si audita)
...
| **audit della PROVENIENZA** | "questo dato ce l'ho DAVVERO, o lo sto inventando?" | recupero fallito / richiesta di un fatto specifico incerto | [[class-confabulation-retrieval-failure]] (F16 held-out) |
...
## Links
[[class-stagnation-recovery]] · [[gold-example-transfer-assumption-audit]] · [[class-consequence-intention-conflict]] · [[class-confabulation-retrieval-failure]] · [[../concepts/compositional-curriculum-thinking-optimization]] · [[area-03-reasoning-scientific-method]] · [[area-04-context-metacognition]] · [[../feedback_reward_hacking_principle]] · [[../feedback_intelligence_gap_to_training_class]] · [[../feedback_transfer_always_cross_domain]]
