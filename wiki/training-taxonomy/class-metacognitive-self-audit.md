...
description: Classe-PADRE (radice) di training — auditare il PROPRIO ragionamento/stato-cognitivo contro il ground-truth invece di fidarsi del primo-passo. Figlie: audit-del-progresso (stagnation-recovery), audit-delle-assunzioni (transfer-assumption-audit), audit-coerenza-mezzi-fini (consequence-intention-conflict), audit-della-provenienza / RECALL (confabulation-retrieval-failure), memoria-prospettica / SAVE (prospective-memory), audit-presa-in-carico (instruction-phase-clarification), audit-impulso-esecutivo / fedeltà (instruction-fidelity-no-overreach), audit-della-PORTATA-DELLO-STRUMENTO (instrument-epistemic-reach, nodo intermedio con 4 figlie proprie al 2026-09-12). RE-HOME 2026-07-11: audit-integrità-della-verifica (independent-verification-integrity) spostata alla radice-sorella ground-truth-integrity (cross-link, resta parente per la faccetta provenienza-dell'audit). RE-HOME 2026-07-18: tool-perception-fidelity NON è più figlia diretta — è scesa di un livello sotto il nuovo nodo intermedio instrument-epistemic-reach (resta NIPOTE). Gerarchia obbligatoria (regola #20). Figlie MISURATE al 2026-09-12: 23 (le otto nominate qui sono le originarie; l'elenco completo e' nella tabella sotto e nel registro §6 del playbook, generato da check-hierarchy); reciprocità verificata dal checker a ogni commit (0 legami a senso unico) — la frase «reciprocità ANCORA ROTTA: 6 classi» che stava qui era stantia.
type: training-class
...
| **RAGGIUNGIBILITA' dell'artefatto** *(2026-07-25)* | il proprio giudizio **"ho finito"** — verificato contro *qualcuno ci arriva?*, non contro *funziona?* | [[class-artifact-reachability-completion]]  ||
| **FORMA dei propri difetti** *(2026-07-25)* | la propria **lista di problemi**, letta come **dato** e non come coda: se N hanno la stessa forma, manca **un punto di passaggio obbligato** — riparare le foglie lascia intatta la causa | [[class-defect-shape-reading]] *(sorella di `exposure-measurement`: quella misura **quanto**, questa **che forma**)*  ||
| **I PRESUPPOSTI (tre facce)** *(2026-07-25, opzione A scelta dall'utente)* | i presupposti **non sono solo i tuoi**: (1) i **miei** prima di iniziare · (2) quelli **altrui** che il mio lavoro tocca · (3) quelli **ereditati** da una diagnosi — *il problema esiste davvero?* | [[class-assumption-audit-both-directions]] *(la faccia 2 e' coperta da `accidental-property-removal` e `retroactive-decision-propagation`, che restano sotto i loro padri: l'asse si **dichiara**, non si spezza la gerarchia)*  ||
| **ORDINE DI COSTRUZIONE per certezza** *(2026-09-11, ratificata su delega msg 2208)* | *da dove parto?* — dalle parti di cui ho **tutte** le informazioni; il rischio load-bearing si **sonda** subito, non si costruisce né si rimanda | lavoro a più parti con completezza diversa | [[class-confident-first-sequencing]] (sorella di effort-honesty: là la difficoltà, qui la completezza dell'informazione) |
| **ATTENZIONE ai segnali RICORRENTI** *(2026-09-11, ratificata su delega msg 2208)* | un errore/avviso che si ripete: **notato, capito, deciso, tracciato**, una volta — non abituazione, non over-triage, mai tacitato | segnale che si ripete da N turni | [[class-recurring-signal-triage]] (sorella di attentional-scope-exit) |
