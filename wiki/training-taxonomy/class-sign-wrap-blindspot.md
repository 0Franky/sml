...
> **Padre**: DA-DECIDERE — classe **orfana**, nessun padre mai dichiarato né ratificato. Cercato: frontmatter, corpo di questa pagina, e ogni file che la nomina; [[class-stagnation-recovery]] la cita come **generatore/trigger naturale** (§Label-generation, §Links) — che è una relazione *di produzione dei task*, non di ereditarietà — e dichiara a sua volta [[class-metacognitive-self-audit]] come proprio padre. L'unico candidato mai messo per iscritto è [[class-stagnation-recovery]] in `../dataset-audit-2026-07-10.md:26`, ma **come proposta aperta** ("dichiarare padre (candidato: …) **o** motivare lo standalone"), mai ratificata (regola #26); `../roadmap-2026-07-16.md:48` la registra tuttora come orfana. Scelta di design pendente per l'utente: agganciarla o motivarne lo standalone.
