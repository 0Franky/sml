...
> **Padre**: [[class-stagnation-recovery]] *(assegnato 2026-07-25, mandato utente msg 1860/1866 — copre l'ASSEGNAZIONE, non la ratifica del contenuto)*. **L'argomento viene dal modo-di-fallimento REALE osservato**, non dalla superficie tecnica: il modello **NOTA l'anomalia** (*"l'esempio non torna... forse conta il segno?"*), arriva **sul bordo della soluzione**, e **si arrende** dopo 17 turni di thrashing. Il gap non e' percettivo — e' che **un'anomalia notata non viene convertita in revisione dell'assunzione**, che e' esattamente la skill del padre. Questa classe ne e' la **specializzazione al caso in cui l'assunzione sbagliata e' ARITMETICA e il dominio non evoca l'edge** (il wrap *disguised*: sul wrap idiomatico — orologio, bussola, calendario — il modello **non** casca, ed e' il controllo-negativo). *(Il file gia' registrava che il padre la cita come **generatore/trigger naturale**: quella era la relazione vista dal lato della produzione dei task; qui e' resa gerarchica nel verso giusto — #20.)* — **storia**: era orfana, DA-DECIDERE
