...
**FIGLIA (assegnata 2026-07-25)**: [[class-prospective-obligation-discharge]] — **CHIUDERE** l'obbligazione, non solo ricordarla. Questa classe insegna a **non perdere** un impegno differito; la figlia insegna il passo che lo **estingue**: riconoscere che il momento e' arrivato, agire, e **segnare che e' chiuso** — altrimenti l'impegno ricordato-per-sempre e' un costo che non scade mai. *(Asse completo: contrarre → ricordare → **saldare**.)*
