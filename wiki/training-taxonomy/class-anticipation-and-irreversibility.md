...
- **FIGLIA (assegnata 2026-07-25)**: [[class-compositional-reversibility]] — **la reversibilita' COMPOSTA**. Qui si pesa la reversibilita' del **singolo** passo; li' il caso in cui **ogni passo e' reversibile e la SEQUENZA non lo e'** (ognuno si annulla da solo, insieme no — l'ordine di annullamento non esiste, o una risorsa intermedia e' gia' stata consumata). E' la specializzazione naturale della radice *pesa-prima-di-committare*: sposta la domanda dal **passo** al **piano**.
