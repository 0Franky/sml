...
> **Proposta di oracolo per il lab (2026-09-11, non costruito — #26)**: operazionalizzare *«stanno insieme»* come **co-accesso**. La fixture dà N fatti **e** un insieme di **domande d'uso** (ciò che chi legge farà dopo): due fatti che le domande chiedono **insieme** appartengono alla stessa unità; due fatti che le domande chiedono **separatamente** no. Allora il reward della radice diventa calcolabile: **①** costo di lettura = numero di unità da aprire per rispondere alle domande (la struttura giusta lo minimizza) · **②** costo di modifica = unità toccate quando un fatto cambia (le domande dicono quali fatti cambiano insieme) · **③** simmetria = per costruzione metà delle fixture hanno fatti da separare. È lo stesso oracolo del gemello di codice ([[class-module-boundary-flow-convergence]]: i **flussi** dicono cosa converge; qui le **domande** dicono cosa sta insieme), e la faccia (b) si ottiene dando una struttura **sbagliata di proposito** come punto di partenza. Il **percorso di lettura** (cosa si vede per primo) si misura con l'ordine delle domande per frequenza. Residuo: le domande d'uso sono **date** dalla fixture — nel mondo vanno inferite, ed è la parte che questo oracolo non misura.
