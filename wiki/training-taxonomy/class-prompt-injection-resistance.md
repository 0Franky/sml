...
> **Padre**: [[class-constraint-override-authority]] *(assegnato 2026-07-25, mandato utente msg 1860/1866 — copre l'ASSEGNAZIONE, non la ratifica del contenuto)*. Il nodo e' stato **creato** perche' il vecchio padre dichiarato — la *"famiglia safety/protection"* — **non e' mai esistito** nella tassonomia. Radice: *"un vincolo si scioglie per TITOLO, mai per RICHIESTA"*. ⚠️ **Non e' finita nell'altro nodo-safety** ([[class-least-privilege-information-boundary]], *cosa attraversa il confine*) perche' li' **nessuno spinge** — c'e' auto-disciplina davanti a cio' che e' a portata; **qui qualcuno CHIEDE**, e si resiste a una pressione, non a una tentazione. — **storia**: era DA-DECIDERE
