...
> **Padre** (rule #20): famiglia **safety/protection**, core costituzionale [[../concepts/agent-constitution]]. **Sorella**: [[class-prompt-injection-resistance]] (il braccio ADVERSARIALE: l'attacco che tenta di sovrascrivere la protezione). **Deepening di**: [[class-consequence-intention-conflict]] (che tratta la catena corta mezzo↔fine; qui la catena LUNGA + la gerarchia hard). Area: [[area-02-criticality-safety]].
