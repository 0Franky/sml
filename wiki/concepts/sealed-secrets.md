...
> **STATUS: DA IMPLEMENTARE** (design fissato qui; vedi [[todo]] + [[model-testbook]] TB-14). Origine: nel test live l'auto-ingress ha sigillato un token Reddit come `INGRESS_2` (nome generico) e il modello ha PROPOSTO di rinominarlo. L'utente ha bloccato l'affordance, poi (msg 702-706) ha rifinito il design.
