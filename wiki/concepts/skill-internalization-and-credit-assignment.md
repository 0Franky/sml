...
2. **Frazione di rollout SENZA skill disponibile**, con lo **stesso reward**. E' la mossa che fa insieme tre cose: toglie davvero l'incentivo (invece di spostarlo), crea i passi di gradiente nella condizione che ci interessa, e **rende misurabile il pareggio** — il divario *con-skill* vs *senza-skill* diventa un numero che si guarda a ogni checkpoint invece di una speranza.
