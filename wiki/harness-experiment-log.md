...
| E10 | 2026-07-05 ~08:10 | **A/B VERSIONATO hard10, n=10** (H6 conferma + tabella versionata, utente msg 1103) | vanilla, ours-full, ours-lean {keep6}, **n=10** PULITO (0 err) | `humaneval-hard10` (5 hard {32,126,129,132,145} + 5 per proxy {69,94,95,141,133}) | **vanilla 8/10 (80%) · ours-full 7/10 (70%) · ours-lean 8/10 (80%)**; lean **−16% tok** vs full (46K vs 55K). **H6 CONFERMATO a n=10**: full<vanilla su hard, lean recupera a vanilla. Modo-2 spaziato in re-run (rate-limit free) | `report-versioned.json` + [[harness-benchmark-versions]] |
