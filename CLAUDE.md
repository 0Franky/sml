...
*Generato da Cowork / Claude Dispatch — Aprile 2026 — Aggiornato 2026-07-05 (regola #21 negative-examples+completezza-dataset + regola #20 classi-gerarchiche-sempre + regola #19 transfer-cross-dominio-sempre + regola #18 gap-intelligenza→classe-training + regola #17 lezione→regola/test-sempre + regola #16 SSOT/DRY)*
