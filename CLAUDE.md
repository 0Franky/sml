...
*Generato da Cowork / Claude Dispatch — Aprile 2026 — Aggiornato 2026-07-06 (regola #22 integrità-fattuale-training-set: mai-fatti-inventati + split verificato-vs-incerto→verify-step + regola #21 negative-examples+completezza-dataset + regola #20 classi-gerarchiche-sempre + regola #19 transfer-cross-dominio-sempre + regola #18 gap-intelligenza→classe-training + regola #17 lezione→regola/test-sempre + regola #16 SSOT/DRY)*
